...
const GradientShape = () => {
  return (
    <>
      ...
      <div className="absolute -left-0 bottom-[10px] w-[400px] h-[200px] rounded-r-full bg-opacity-[.07] rounded-ful bg-accent blur-[150px]"></div>
      ...
      <div className="absolute -left-0 bottom-[740px] w-[400px] h-[450px] rounded-r-full bg-opacity-[.06] rounded-ful bg-primary blur-[150px]"></div>
    </>
  );
};
